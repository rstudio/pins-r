...
In most cases, a remote resource does not change over time. For example, since the House Price Index dataset from the [Getting Started](pin-starting.html) section is unlikely to change, it can be retrieved as follows:
