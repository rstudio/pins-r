...
However, since it's a best practice to not store secrets in plain text, `pins` will also read the key from the `RSCONNECT_API_KEY` environment variable, or you can retrieve explicitly as `Sys.getenv("RSCONNECT_API_KEY")` before assigning it to the key parameter.
