...
This vignette shows a couple of examples converting legacy code to the modern API, then provides a full set of equivalences between the legacy and modern function names.
...
(I find it a little confusing that this uses `pin()` rather than `pin_get()`.)
...
| `board_register_datatxt()`   | Not implemented     |
| `board_register_dospace()`   | Not implemented     |
| `board_register_gcloud()`    | Not implemented     |
| `board_register_github()`    | Not implemented     |
| `board_register_local()`     | `board_local()`     |
| `board_register_kaggle()`    | Not implemented     |
