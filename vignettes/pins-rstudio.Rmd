...
![](images/rstudio-pins-addin-menu.png){width=260px}
...
![](images/rstudio-pins-addin-search.png){width=400px}
...
You can connect to several different boards to discover, pin and share resources. This boards will be introduced in the [GitHub](boards-github.html), [Kaggle](boards-kaggle), and [RStudio Connect](boards-rsconnect.html articles. However, you can also use this functionality to connect to the default local board, and explore the pins that you've created with `pin()`.
...
Once connected to a board, you can browse pins available in that particular board using the connections pane:

![](images/rstudio-pins-connection-pane.png){width=460px}

Each pin can the be expanded to show, when available, the columns each resource contains.

![](images/rstudio-pins-connection-columns.png){width=460px}
...
The next section, [Understanding Boards](boards-understanding.html), will properly present what exactly a board is and how to configure additional storage locations.
