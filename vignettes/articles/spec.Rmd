...
`pin_meta()` retrieves metadata from the remote board and adds to it any additional data needed to manage the local cache. At a minimum this must always include the `cache_dir`.
