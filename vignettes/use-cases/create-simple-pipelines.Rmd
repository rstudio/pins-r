...
YOu can then retrieve the previous automated pin, apply the GPT-2 text generation model and pin the result in a new pin -- which essentially creates a simple data processing pipeline:
...
You can browse this application running at [beta.rstudioconnect.com/connect/#/apps/6565/access](https://beta.rstudioconnect.com/connect/#/apps/6565/access)

[![](images/create-pipelines-rsconnect.png)](https://beta.rstudioconnect.com/connect/#/apps/6565/access)

You could also create an automated report to process this dataset with the techniquest presented on [Automate Dataset Updates](automate-dataset-updates.html).
