...
In order to use Microsoft Azure Storage as a [board](boards-understanding.html), you need to an Azure Storage account, an Azure Storage container, and an Azure Storage key. You can sign-up and create those from [portal.azure.com](https://portal.azure.com):
