...
pins_site_gallery(list(
  list(image       = "images/use-cases-reuse-tidy-datasets.png",
   ...
   list(image       = "images/use-cases-update-shiny-apps.png",
       ...
       description = "Last but not least, you can use pins with Plumber and Shiny apps to updatee them with ease by reusing datasets, models or visualizations generated with pins. For instance, we can create a web application that makes use of a data pipeline by converting the results into a reactive pin.",
