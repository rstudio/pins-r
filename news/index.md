...
- Further escalated gradual deprecation process for legacy pins
  functions such as [`pin()`](https://pins.rstudio.com/reference/pin.md)
  ([\#879](https://github.com/rstudio/pins-r/issues/879)).

- Added support for
  [`pin_list()`](https://pins.rstudio.com/reference/pin_list.md) to
  [`board_gcs()`](https://pins.rstudio.com/reference/board_gcs.md) for
...
- Escalated gradual deprecation process for legacy pins functions such
  as [`pin()`](https://pins.rstudio.com/reference/pin.md)
...
- Started gradual deprecation process for legacy pins functions such as
  [`pin()`](https://pins.rstudio.com/reference/pin.md)
...
- Changed the function signature of
  [`pin_write()`](https://pins.rstudio.com/reference/pin_read.md) so
...
- Fixed how dots are checked in
  [`pin_write()`](https://pins.rstudio.com/reference/pin_read.md) to
...
- [`pin_write()`](https://pins.rstudio.com/reference/pin_read.md) no
...
- The `print` method for boards no longer calls
  [`pin_list()`](https://pins.rstudio.com/reference/pin_list.md)
  internally ([\#718](https://github.com/rstudio/pins-r/issues/718)).

- [`board_s3()`](https://pins.rstudio.com/reference/board_s3.md) now
...
- Added new board for Google Cloud Storage
  [`board_gcs()`](https://pins.rstudio.com/reference/board_gcs.md)
...
- Updated
  [`board_url()`](https://pins.rstudio.com/reference/board_url.md) to
  handle versions recorded via a manifest file
...
- [`board_deparse()`](https://pins.rstudio.com/reference/board_deparse.md)
...
- [`legacy_github()`](https://pins.rstudio.com/reference/legacy_github.md)
  works once again
  ([\#549](https://github.com/rstudio/pins-r/issues/549)).

- [`pin_meta()`](https://pins.rstudio.com/reference/pin_meta.md) now
  includes pin `name`
  ([\#544](https://github.com/rstudio/pins-r/issues/544)).

- [`board_register()`](https://pins.rstudio.com/reference/board_register.md)
...
The legacy API ([`pin()`](https://pins.rstudio.com/reference/pin.md),
[`pin_get()`](https://pins.rstudio.com/reference/pin_get.md), and
[`board_register()`](https://pins.rstudio.com/reference/board_register.md))
...
[`vignette("pins-update")`](https://pins.rstudio.com/articles/pins-update.md).
...
- [`pin_read()`](https://pins.rstudio.com/reference/pin_read.md) and
  ...
  [`pin_get()`](https://pins.rstudio.com/reference/pin_get.md) and
  [`pin()`](https://pins.rstudio.com/reference/pin.md).
  [`pin_write()`](https://pins.rstudio.com/reference/pin_read.md) has a
  `type` argument that allows you to choose how to serialise your R
  objects to disk, allowing you to manage the tradeoffs between speed,
...
- [`pin_download()`](https://pins.rstudio.com/reference/pin_download.md)
  ...
  [`pin_read()`](https://pins.rstudio.com/reference/pin_read.md) and
  [`pin_write()`](https://pins.rstudio.com/reference/pin_read.md) that
  work with file paths rather than R objects. They replace the use of
  [`pin()`](https://pins.rstudio.com/reference/pin.md) with a path and
  eliminate the type-instability in
  [`pin_get()`](https://pins.rstudio.com/reference/pin_get.md), which
  can return either an R object or a character vector of paths.

- [`pin_browse()`](https://pins.rstudio.com/reference/pin_browse.md)
  replaces
  [`board_browse()`](https://pins.rstudio.com/reference/custom-boards.md),
...
- [`pin_delete()`](https://pins.rstudio.com/reference/pin_delete.md)
  replaces
  [`pin_remove()`](https://pins.rstudio.com/reference/pin_remove.md),
  and can delete multiple pins
  ([\#433](https://github.com/rstudio/pins-r/issues/433)).

- [`pin_list()`](https://pins.rstudio.com/reference/pin_list.md) lists
  all pins in a board.

- [`pin_meta()`](https://pins.rstudio.com/reference/pin_meta.md)
  replaces
  [`pin_info()`](https://pins.rstudio.com/reference/pin_info.md) and
...
- [`pin_search()`](https://pins.rstudio.com/reference/pin_search.md)
  replaces
  [`pin_find()`](https://pins.rstudio.com/reference/pin_find.md). It is
  much more limited because the previous version was based on
...
- [`pin_reactive_read()`](https://pins.rstudio.com/reference/pin_reactive_read.md)
  ...
  replace
  [`pin_reactive()`](https://pins.rstudio.com/reference/pin_reactive.md).
...
- [`board_kaggle_dataset()`](https://pins.rstudio.com/reference/board_kaggle.md)
...
- [`board_rsconnect()`](https://pins.rstudio.com/reference/board_connect.md)
  ...
  [`pin_read()`](https://pins.rstudio.com/reference/pin_read.md) pins
  created by [`pin()`](https://pins.rstudio.com/reference/pin.md), but
  you can’t [`pin_get()`](https://pins.rstudio.com/reference/pin_get.md)
  pins created by
  [`pin_write()`](https://pins.rstudio.com/reference/pin_read.md).

- [`board_s3()`](https://pins.rstudio.com/reference/board_s3.md) stores
  data in Amazon’s S3 service. It is built on top of paws.

- [`board_url()`](https://pins.rstudio.com/reference/board_url.md) lets
  you create a manual board from a vector of URLs. This is useful
  because
  [`pin_download()`](https://pins.rstudio.com/reference/pin_download.md)
  and [`pin_read()`](https://pins.rstudio.com/reference/pin_read.md) are
  cached, so they only re-download the data if it has changed since the
  last time you used it
  ([\#409](https://github.com/rstudio/pins-r/issues/409)). This board is
  a replacement for
  [`pin()`](https://pins.rstudio.com/reference/pin.md)’s ability to work
  directly with URLs
...
- The “packages” board is no longer registered by default; if you want
  ...
  packages, and it
  [`pin_find()`](https://pins.rstudio.com/reference/pin_find.md) now
...
- [`pin_fetch()`](https://pins.rstudio.com/reference/pin_fetch.md) has
  been removed
...
- Avoid Windows crashing in
  [`pin()`](https://pins.rstudio.com/reference/pin.md) under some
...
- [`pin_find()`](https://pins.rstudio.com/reference/pin_find.md) no
...
- Increase total entries retrieved with
  [`pin_find()`](https://pins.rstudio.com/reference/pin_find.md),
...
- For files bigger than 100MB
  [`pin()`](https://pins.rstudio.com/reference/pin.md) creates symlinks
  to speed up uploads, can be configured using the `pins.link.size`
  option ([\#273](https://github.com/rstudio/pins-r/issues/273)).
...
- Fix warning when using
  [`pin()`](https://pins.rstudio.com/reference/pin.md) against storage
  locations with custom domain name
...
- Fix [`pin()`](https://pins.rstudio.com/reference/pin.md) failing to
  update cache when server returns `NULL` etag.

- Support for `custom_metadata` in
  [`pin()`](https://pins.rstudio.com/reference/pin.md) to allow saving
  custom fields in `data.txt` file.

- Improve performannce for
  [`pin()`](https://pins.rstudio.com/reference/pin.md) from URLs
...
- Finding pins with
  [`pin_find()`](https://pins.rstudio.com/reference/pin_find.md) sort
  results by default
...
- Support for using [`pin()`](https://pins.rstudio.com/reference/pin.md)
  across multiple concurrent processes
  ([\#182](https://github.com/rstudio/pins-r/issues/182)).

- Support in
  [`pin_get()`](https://pins.rstudio.com/reference/pin_get.md) to
...
- [`pin()`](https://pins.rstudio.com/reference/pin.md) now refreshes the
  connections pane.

- [`pin_remove()`](https://pins.rstudio.com/reference/pin_remove.md) now
  refreshes the connections pane.

### RStudio Connect

- Support for `code` parameter in
  [`pin()`](https://pins.rstudio.com/reference/pin.md) to customize R
  code used in the UI to retrieve the pin
  ([\#77](https://github.com/rstudio/pins-r/issues/77)).

- Improve error message for
  [`pin_get()`](https://pins.rstudio.com/reference/pin_get.md) with
  duplicate names
...
- Support for custom GitHub hosts including GitHub Enterprise using the
  `host` parameter in
  [`board_register_github()`](https://pins.rstudio.com/reference/legacy_github.md)
  ([\#163](https://github.com/rstudio/pins-r/issues/163)).

### Websites

- Using [`pin()`](https://pins.rstudio.com/reference/pin.md) now
...
- [`pin_info()`](https://pins.rstudio.com/reference/pin_info.md) adds
  support for `metadata` parameter to avoid retrieving pin contents.
...
- [`pin_info()`](https://pins.rstudio.com/reference/pin_info.md) prints
  long character strings in their own line.

- Fixed issue in
  [`pin_remove()`](https://pins.rstudio.com/reference/pin_remove.md) for
  S3, Azure, GCloud, Google and website boards
...
- Added missing `key` parameter in
  [`board_register_azure()`](https://pins.rstudio.com/reference/legacy_azure.md).
...
- [`pin()`](https://pins.rstudio.com/reference/pin.md) extracts URLs
  that end in `.gz` and `zip`, which can be disabled with
  `pin("<url>", extract = FALSE)`.

- [`pin()`](https://pins.rstudio.com/reference/pin.md) no longer prints
  the pin, you can revert this behavior with
...
- Avoid changing `data.table` when using
  [`pin()`](https://pins.rstudio.com/reference/pin.md) and `get_pin()`.

- Support for
  [`pin_info()`](https://pins.rstudio.com/reference/pin_info.md) to
  describe a pin and `extended = TRUE` in
  [`pin_find()`](https://pins.rstudio.com/reference/pin_find.md) to show
  all extended information about each pin.

- Support for `extract` parameter in
  [`pin_get()`](https://pins.rstudio.com/reference/pin_get.md),
  [`pin()`](https://pins.rstudio.com/reference/pin.md), and
  [`pin_reactive()`](https://pins.rstudio.com/reference/pin_reactive.md)
...
- Support creating automatic `name` when using
  [`pin()`](https://pins.rstudio.com/reference/pin.md) and multiple URL.
...
- Fix issue where
  [`pin_find()`](https://pins.rstudio.com/reference/pin_find.md) would
  not show all available pins.
...
- Removed [`pin_find()`](https://pins.rstudio.com/reference/pin_find.md)
...
- The `name` parameter in
  [`board_register_datatxt()`](https://pins.rstudio.com/reference/legacy_datatxt.md)
  is now optional.

- Fix in [`pin_find()`](https://pins.rstudio.com/reference/pin_find.md)
...
- Registers “local” board by default, you no longer need to explicitly
  run
  [`board_register_local()`](https://pins.rstudio.com/reference/legacy_local.md)
