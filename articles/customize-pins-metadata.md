...
[`pin_read()`](https://pins.rstudio.com/reference/pin_read.md) for your
particular use case.

To see a different approach for when you want to write and read whole
file(s) in a customized way, see
[`vignette("managing-custom-formats")`](https://pins.rstudio.com/articles/managing-custom-formats.md).
...
#> Creating new version '20260309T150737Z-099e2'
...
[`pin_read()`](https://pins.rstudio.com/reference/pin_read.md) function,
but the object we get is no longer a factor!
