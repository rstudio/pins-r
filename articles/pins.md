...
#> Guessing `type = 'rds'`
#> Creating new version '20260309T150745Z-bbc0c'
...
#> List of 13
#>  $ file       : chr "mtcars.rds"
#>  $ file_size  : 'fs_bytes' int 901
#>  $ pin_hash   : chr "bbc0cc50cb7f7daf"
#>  $ type       : chr "rds"
#>  $ title      : chr "mtcars: a pinned 32 x 11 data frame"
#>  $ description: NULL
#>  $ tags       : NULL
#>  $ urls       : NULL
#>  $ created    : POSIXct[1:1], format: "2026-03-09 15:07:45"
#>  $ api_version: int 1
#>  $ user       : list()
#>  $ name       : chr "mtcars"
#>  $ local      :List of 3
#>   ..$ dir    : 'fs_path' chr "/tmp/Rtmp6IsCXj/pins-221a6ffb6055/mtcars/20260309T150745Z-bbc0c"
#>   ..$ url    : NULL
#>   ..$ version: chr "20260309T150745Z-bbc0c"
```
...
- a unique `pin_hash` that you can supply to
  [`pin_read()`](https://pins.rstudio.com/reference/pin_read.md) to
...
#> Using `name = 'mtcars'`
#> Guessing `type = 'rds'`
#> Replacing version '20260309T150745Z-bbc0c' with
#> '20260309T150746Z-bbc0c'
#> Writing to pin 'mtcars'
board |> pin_meta("mtcars")
#> List of 13
#>  $ file       : chr "mtcars.rds"
...
#>  $ tags       : NULL
#>  $ urls       : NULL
#>  $ created    : POSIXct[1:1], format: "2026-03-09 15:07:46"
#>  $ api_version: int 1
#>  $ user       :List of 1
#>   ..$ source: chr "Henderson and Velleman (1981), Building multiple regression models interactively. Biometrics, 37, 391–411."
#>  $ name       : chr "mtcars"
#>  $ local      :List of 3
#>   ..$ dir    : 'fs_path' chr "/tmp/Rtmp6IsCXj/pins-221a6ffb6055/mtcars/20260309T150746Z-bbc0c"
#>   ..$ url    : NULL
#>   ..$ version: chr "20260309T150746Z-bbc0c"
```
...
[`pin_write()`](https://pins.rstudio.com/reference/pin_read.md) will
...
#> Creating new version '20260309T150747Z-796ae'
#> Writing to pin 'x'
board2 |> pin_write(2:6, name = "x", type = "rds")
#> Creating new version '20260309T150747Z-b2fbc'
#> Writing to pin 'x'
board2 |> pin_write(3:7, name = "x", type = "rds")
#> Creating new version '20260309T150747Z-dbf3d'
#> Writing to pin 'x'
```
...
#>   <chr>                  <dttm>              <chr>
#> 1 20260309T150747Z-796ae 2026-03-09 15:07:47 796ae
#> 2 20260309T150747Z-b2fbc 2026-03-09 15:07:47 b2fbc
#> 3 20260309T150747Z-dbf3d 2026-03-09 15:07:47 dbf3d
```
...
By default,
[`pin_read()`](https://pins.rstudio.com/reference/pin_read.md) will
...
[`pin_read()`](https://pins.rstudio.com/reference/pin_read.md) which
...
works like
[`pin_write()`](https://pins.rstudio.com/reference/pin_read.md) but
...
#> Creating new version '20260309T150747Z-e9d42'
```
...
#> [1] "/tmp/Rtmp6IsCXj/pins-221a6ffb6055/example/20260309T150747Z-e9d42/mtcars.csv"  
#> [2] "/tmp/Rtmp6IsCXj/pins-221a6ffb6055/example/20260309T150747Z-e9d42/alphabet.txt"
```
...
Note that you can’t
[`pin_read()`](https://pins.rstudio.com/reference/pin_read.md) something
you pinned with
[`pin_upload()`](https://pins.rstudio.com/reference/pin_download.md):
...
#> [1] "/tmp/Rtmp6IsCXj/pins-221a6ffb6055/mtcars/20260309T150746Z-bbc0c/mtcars.rds"
```
...
[`board_url()`](https://pins.rstudio.com/reference/board_url.md) — you
can assemble your own board from datasets, wherever they live on the
...
[`pin_download()`](https://pins.rstudio.com/reference/pin_download.md)
with [`read.csv()`](https://rdrr.io/r/utils/read.table.html)[¹](#fn1):
