...
[`board_s3()`](https://pins.rstudio.com/reference/board_s3.md). The goal
of this vignette is to show how to publish a board of pins to a website,
...
- For publishers, a helper function is provided,
  ...
  read like a
  [`board_s3()`](https://pins.rstudio.com/reference/board_s3.md) or
...
[`board_url()`](https://pins.rstudio.com/reference/board_url.md) are:
...
[`board_s3()`](https://pins.rstudio.com/reference/board_s3.md).
...
Because a
[`board_url()`](https://pins.rstudio.com/reference/board_url.md) is
...
[`board_url()`](https://pins.rstudio.com/reference/board_url.md) is set
up by a consumer for reading, the pins package uses this file to
discover the pins and their versions. The manifest file is the key to
[`board_url()`](https://pins.rstudio.com/reference/board_url.md)’s
...
[`board_url()`](https://pins.rstudio.com/reference/board_url.md) can
behave as a read-only version of a
[`board_folder()`](https://pins.rstudio.com/reference/board_folder.md).
Let’s create a
[`board_url()`](https://pins.rstudio.com/reference/board_url.md) using
our fake URL:
...
The [`board_url()`](https://pins.rstudio.com/reference/board_url.md)
