...
To search Kaggle datasets with `find_pin()`, you will have to download a token file after signing in to [kaggle.com](https://kaggle.com/me/account). You can then activate this token file when you register the Kaggle board:
