...
You can also discover remote resources using `pin_find()` which searches any registered boards. For instance, we can search datasets mentioning "air" in installed packages with:
...
```{r rstudio-plot-pin, fig.align='center', eval = FALSE}
library(ggplot2)
board <- board_rsconnect()
