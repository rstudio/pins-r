...
You can pin objects to a variety of pin *boards*, including folders (to share on a networked drive or with DropBox), RStudio Connect, Amazon S3, Azure blob storage, and more.
