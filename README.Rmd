...
Which we can analyze an pin with `DBI`:
...
Which we could then use at a later time to experiment with plots and avoid rerunning this query as out session restarts:
