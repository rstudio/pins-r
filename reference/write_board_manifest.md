...
or [`board_s3()`](https://pins.rstudio.com/reference/board_s3.md), then
served as a website, such that others can consume using
[`board_url()`](https://pins.rstudio.com/reference/board_url.md). The
manifest file is *not* versioned like a pin is, and this function will
overwrite any existing `_pins.yaml` file on your board. It is your
...
[`pin_find()`](https://pins.rstudio.com/reference/pin_find.md)) is
...
#> Creating new version '20260309T150735Z-48c73'
#> Writing to pin 'mtcars-csv'
pin_write(board, mtcars, "mtcars-json", type = "json")
#> Creating new version '20260309T150735Z-c2702'
...
#> mtcars-csv:
#> - mtcars-csv/20260309T150735Z-48c73/
#> mtcars-json:
#> - mtcars-json/20260309T150735Z-c2702/

# if you write another pin, the manifest file is out of date:
pin_write(board, 1:10, "nice-numbers", type = "json")
#> Creating new version '20260309T150735Z-c3943'
