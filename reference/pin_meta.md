...
- Standard metadata added by
  [`pin_upload()`](https://pins.rstudio.com/reference/pin_download.md)/[`pin_write()`](https://pins.rstudio.com/reference/pin_read.md).
  This includes:
...
- Metadata supplied by the user, stored in `$user`. This is untouched
  ...
  [`pin_write()`](https://pins.rstudio.com/reference/pin_read.md)/[`pin_upload()`](https://pins.rstudio.com/reference/pin_download.md)
