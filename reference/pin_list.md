...
[`pin_search()`](https://pins.rstudio.com/reference/pin_search.md) to
get more data about each pin in a convenient form.
...
#> Guessing `type = 'rds'`
#> Creating new version '20260309T143712Z-796ae'
#> Writing to pin 'x'
board |> pin_write(letters, "y")
#> Guessing `type = 'rds'`
#> Creating new version '20260309T143712Z-471d8'
#> Writing to pin 'y'
board |> pin_write(runif(20), "z")
#> Guessing `type = 'rds'`
#> Creating new version '20260309T143712Z-8d62d'
#> Writing to pin 'z'
