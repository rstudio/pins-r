...
[`pin_write()`](https://pins.rstudio.com/reference/pin_read.md) that you
can use to pin any file, as opposed to any R object. The path returned
by `pin_download()` is a read-only path to a cached file: you should
never attempt to modify this file.
...
#> Creating new version '20260309T150730Z-f5b9d'
path <- board |> pin_download("CITATION")
path
#> [1] "/tmp/RtmpZz6t6S/pins-1b125db57647/CITATION/20260309T150730Z-f5b9d/CITATION"
readLines(path)[1:5]
#> [1] "bibentry(\"Manual\","                                                         
