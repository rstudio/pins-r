...
#> Guessing `type = 'rds'`
#> Creating new version '20260313T165900Z-2943a'
...
#>  $ pin_hash   : chr "2943a8daa951c179"
#>  $ type       : chr "rds"
#>  $ title      : chr "mtcars: a pinned 32 x 11 data frame"
#>  $ description: NULL
#>  $ tags       : NULL
#>  $ urls       : NULL
#>  $ created    : POSIXct[1:1], format: "2026-03-13 16:59:00"
#>  $ api_version: int 1
#>  $ user       : list()
#>  $ name       : chr "mtcars"
#>  $ local      :List of 3
#>   ..$ dir    : 'fs_path' chr "/tmp/RtmpNj2YF4/pins-254fe42cf99/mtcars/20260313T165900Z-2943a"
#>   ..$ url    : NULL
#>   ..$ version: chr "20260313T165900Z-2943a"
```
...
#> Using `name = 'mtcars'`
#> Guessing `type = 'rds'`
#> Replacing version '20260313T165900Z-2943a' with
#> '20260313T165901Z-2943a'
#> Writing to pin 'mtcars'
board |> pin_meta("mtcars")
#> List of 13
#>  $ file       : chr "mtcars.rds"
...
#>  $ tags       : NULL
#>  $ urls       : NULL
#>  $ created    : POSIXct[1:1], format: "2026-03-13 16:59:01"
#>  $ api_version: int 1
#>  $ user       :List of 1
#>   ..$ source: chr "Henderson and Velleman (1981), Building multiple regression models interactively. Biometrics, 37, 391–411."
#>  $ name       : chr "mtcars"
#>  $ local      :List of 3
#>   ..$ dir    : 'fs_path' chr "/tmp/RtmpNj2YF4/pins-254fe42cf99/mtcars/20260313T165901Z-2943a"
#>   ..$ url    : NULL
#>   ..$ version: chr "20260313T165901Z-2943a"
```
...
#> Creating new version '20260313T165901Z-0aee4'
#> Writing to pin 'x'
board2 |> pin_write(2:6, name = "x", type = "rds")
#> Creating new version '20260313T165901Z-eb4b5'
#> Writing to pin 'x'
board2 |> pin_write(3:7, name = "x", type = "rds")
#> Creating new version '20260313T165901Z-1b37e'
#> Writing to pin 'x'
```
...
#>   <chr>                  <dttm>              <chr>
#> 1 20260313T165901Z-0aee4 2026-03-13 16:59:01 0aee4
#> 2 20260313T165901Z-1b37e 2026-03-13 16:59:01 1b37e
#> 3 20260313T165901Z-eb4b5 2026-03-13 16:59:01 eb4b5
```
...
#> Creating new version '20260313T165902Z-e9d42'
```
...
#> [1] "/tmp/RtmpNj2YF4/pins-254fe42cf99/example/20260313T165902Z-e9d42/mtcars.csv"  
#> [2] "/tmp/RtmpNj2YF4/pins-254fe42cf99/example/20260313T165902Z-e9d42/alphabet.txt"
```
...
#> [1] "/tmp/RtmpNj2YF4/pins-254fe42cf99/mtcars/20260313T165901Z-2943a/mtcars.rds"
```
