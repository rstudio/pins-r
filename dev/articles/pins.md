...
#> Guessing `type = 'rds'`
#> Creating new version '20260309T151010Z-bbc0c'
...
#>  $ tags       : NULL
#>  $ urls       : NULL
#>  $ created    : POSIXct[1:1], format: "2026-03-09 15:10:10"
#>  $ api_version: int 1
#>  $ user       : list()
#>  $ name       : chr "mtcars"
#>  $ local      :List of 3
#>   ..$ dir    : 'fs_path' chr "/tmp/RtmpbdzrVM/pins-21e72c936a49/mtcars/20260309T151010Z-bbc0c"
#>   ..$ url    : NULL
#>   ..$ version: chr "20260309T151010Z-bbc0c"
```
...
#> Using `name = 'mtcars'`
#> Guessing `type = 'rds'`
#> Replacing version '20260309T151010Z-bbc0c' with
#> '20260309T151012Z-bbc0c'
#> Writing to pin 'mtcars'
board |> pin_meta("mtcars")
#> List of 13
#>  $ file       : chr "mtcars.rds"
...
#>  $ tags       : NULL
#>  $ urls       : NULL
#>  $ created    : POSIXct[1:1], format: "2026-03-09 15:10:12"
#>  $ api_version: int 1
#>  $ user       :List of 1
#>   ..$ source: chr "Henderson and Velleman (1981), Building multiple regression models interactively. Biometrics, 37, 391–411."
#>  $ name       : chr "mtcars"
#>  $ local      :List of 3
#>   ..$ dir    : 'fs_path' chr "/tmp/RtmpbdzrVM/pins-21e72c936a49/mtcars/20260309T151012Z-bbc0c"
#>   ..$ url    : NULL
#>   ..$ version: chr "20260309T151012Z-bbc0c"
```
...
#> Creating new version '20260309T151012Z-796ae'
#> Writing to pin 'x'
board2 |> pin_write(2:6, name = "x", type = "rds")
#> Creating new version '20260309T151012Z-b2fbc'
#> Writing to pin 'x'
board2 |> pin_write(3:7, name = "x", type = "rds")
#> Creating new version '20260309T151012Z-dbf3d'
#> Writing to pin 'x'
```
...
#>   <chr>                  <dttm>              <chr>
#> 1 20260309T151012Z-796ae 2026-03-09 15:10:12 796ae
#> 2 20260309T151012Z-b2fbc 2026-03-09 15:10:12 b2fbc
#> 3 20260309T151012Z-dbf3d 2026-03-09 15:10:12 dbf3d
```
...
#> Creating new version '20260309T151012Z-e9d42'
```
...
#> [1] "/tmp/RtmpbdzrVM/pins-21e72c936a49/example/20260309T151012Z-e9d42/mtcars.csv"  
#> [2] "/tmp/RtmpbdzrVM/pins-21e72c936a49/example/20260309T151012Z-e9d42/alphabet.txt"
```
...
#> [1] "/tmp/RtmpbdzrVM/pins-21e72c936a49/mtcars/20260309T151012Z-bbc0c/mtcars.rds"
```
