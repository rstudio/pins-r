...
#> Creating new version '20260313T210920Z-5239d'
...
#>  $ file_size  : 'fs_bytes' int 2.92K
#>  $ pin_hash   : chr "5239dab0f902b9f9"
#>  $ type       : chr "parquet"
#>  $ title      : chr "mtcars: a pinned 32 x 11 data frame"
#>  $ description: NULL
#>  $ tags       : NULL
#>  $ urls       : NULL
#>  $ created    : POSIXct[1:1], format: "2026-03-13 21:09:20"
#>  $ api_version: int 1
#>  $ user       : list()
#>  $ name       : chr "mtcars"
#>  $ local      :List of 3
#>   ..$ dir    : 'fs_path' chr "/tmp/RtmpRCZL4E/pins-24724fe6e11f/mtcars/20260313T210920Z-5239d"
#>   ..$ url    : NULL
#>   ..$ version: chr "20260313T210920Z-5239d"
```
...
#> Using `name = 'mtcars'`
#> Guessing `type = 'parquet'`
#> Replacing version '20260313T210920Z-5239d' with
#> '20260313T210921Z-5239d'
#> Writing to pin 'mtcars'
board |> pin_meta("mtcars")
#> List of 13
#>  $ file       : chr "mtcars.parquet"
...
#>  $ tags       : NULL
#>  $ urls       : NULL
#>  $ created    : POSIXct[1:1], format: "2026-03-13 21:09:21"
#>  $ api_version: int 1
#>  $ user       :List of 1
#>   ..$ source: chr "Henderson and Velleman (1981), Building multiple regression models interactively. Biometrics, 37, 391–411."
#>  $ name       : chr "mtcars"
#>  $ local      :List of 3
#>   ..$ dir    : 'fs_path' chr "/tmp/RtmpRCZL4E/pins-24724fe6e11f/mtcars/20260313T210921Z-5239d"
#>   ..$ url    : NULL
#>   ..$ version: chr "20260313T210921Z-5239d"
```
...
#> Creating new version '20260313T210921Z-0aee4'
#> Writing to pin 'x'
board2 |> pin_write(2:6, name = "x", type = "rds")
#> Creating new version '20260313T210921Z-eb4b5'
#> Writing to pin 'x'
board2 |> pin_write(3:7, name = "x", type = "rds")
#> Creating new version '20260313T210922Z-1b37e'
#> Writing to pin 'x'
```
...
#>   <chr>                  <dttm>              <chr>
#> 1 20260313T210921Z-0aee4 2026-03-13 21:09:21 0aee4
#> 2 20260313T210921Z-eb4b5 2026-03-13 21:09:21 eb4b5
#> 3 20260313T210922Z-1b37e 2026-03-13 21:09:22 1b37e
```
...
#> Creating new version '20260313T210922Z-e9d42'
```
...
#> [1] "/tmp/RtmpRCZL4E/pins-24724fe6e11f/example/20260313T210922Z-e9d42/mtcars.csv"  
#> [2] "/tmp/RtmpRCZL4E/pins-24724fe6e11f/example/20260313T210922Z-e9d42/alphabet.txt"
```
...
#> [1] "/tmp/RtmpRCZL4E/pins-24724fe6e11f/mtcars/20260313T210921Z-5239d/mtcars.parquet"
```
