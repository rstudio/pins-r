...
#> Guessing `type = 'rds'`
#> Creating new version '20251110T190143Z-bbc0c'
...
- `type = "qs"` uses
  [`qs::qsave()`](https://rdrr.io/pkg/qs/man/qsave.html) to create a
  binary R data file, like `writeRDS()`. This format achieves faster
  read/write speeds than RDS, and compresses data more efficiently,
  making it a good choice for larger objects. Read more on the [qs
  package](https://github.com/qsbase/qs).
- `type = "qs2"` uses
  [`qs2::qs_save()`](https://rdrr.io/pkg/qs2/man/qs_save.html) to create
  a binary R data file, similar to `type = "qs"`. The
  [qs2](https://github.com/qsbase/qs2) format is the successor to the
  [qs package](https://github.com/qsbase/qs), but is not compatible with
  the original `qs` format.
...
#>  $ tags       : NULL
#>  $ urls       : NULL
#>  $ created    : POSIXct[1:1], format: "2025-11-10 19:01:43"
#>  $ api_version: int 1
#>  $ user       : list()
#>  $ name       : chr "mtcars"
#>  $ local      :List of 3
#>   ..$ dir    : 'fs_path' chr "/tmp/RtmpfxQCKB/pins-2596302a7ee9/mtcars/20251110T190143Z-bbc0c"
#>   ..$ url    : NULL
#>   ..$ version: chr "20251110T190143Z-bbc0c"
```
...
#> Using `name = 'mtcars'`
#> Guessing `type = 'rds'`
#> Replacing version '20251110T190143Z-bbc0c' with
#> '20251110T190144Z-bbc0c'
#> Writing to pin 'mtcars'
board |> pin_meta("mtcars")
#> List of 13
#>  $ file       : chr "mtcars.rds"
...
#>  $ tags       : NULL
#>  $ urls       : NULL
#>  $ created    : POSIXct[1:1], format: "2025-11-10 19:01:44"
#>  $ api_version: int 1
#>  $ user       :List of 1
#>   ..$ source: chr "Henderson and Velleman (1981), Building multiple regression models interactively. Biometrics, 37, 391–411."
#>  $ name       : chr "mtcars"
#>  $ local      :List of 3
#>   ..$ dir    : 'fs_path' chr "/tmp/RtmpfxQCKB/pins-2596302a7ee9/mtcars/20251110T190144Z-bbc0c"
#>   ..$ url    : NULL
#>   ..$ version: chr "20251110T190144Z-bbc0c"
```
...
#> Creating new version '20251110T190144Z-796ae'
#> Writing to pin 'x'
board2 |> pin_write(2:6, name = "x", type = "rds")
#> Creating new version '20251110T190144Z-b2fbc'
#> Writing to pin 'x'
board2 |> pin_write(3:7, name = "x", type = "rds")
#> Creating new version '20251110T190145Z-dbf3d'
#> Writing to pin 'x'
```
...
#>   <chr>                  <dttm>              <chr>
#> 1 20251110T190144Z-796ae 2025-11-10 19:01:44 796ae
#> 2 20251110T190144Z-b2fbc 2025-11-10 19:01:44 b2fbc
#> 3 20251110T190145Z-dbf3d 2025-11-10 19:01:45 dbf3d
```
...
#> Creating new version '20251110T190145Z-e9d42'
```
...
#> [1] "/tmp/RtmpfxQCKB/pins-2596302a7ee9/example/20251110T190145Z-e9d42/mtcars.csv"  
#> [2] "/tmp/RtmpfxQCKB/pins-2596302a7ee9/example/20251110T190145Z-e9d42/alphabet.txt"
```
...
#> [1] "/tmp/RtmpfxQCKB/pins-2596302a7ee9/mtcars/20251110T190144Z-bbc0c/mtcars.rds"
```
