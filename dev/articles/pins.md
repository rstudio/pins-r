...
#> Creating new version '20260923T003900Z-c0340'
...
#>  $ tags       : NULL
#>  $ urls       : NULL
#>  $ created    : POSIXct[1:1], format: "2026-09-23 00:39:00"
#>  $ api_version: int 1
#>  $ user       : list()
#>  $ name       : chr "mtcars"
#>  $ local      :List of 3
#>   ..$ dir    : 'fs_path' chr "/tmp/Rtmp2efWaP/pins-21b742929cd6/mtcars/20260923T003900Z-c0340"
#>   ..$ url    : NULL
#>   ..$ version: chr "20260923T003900Z-c0340"
```
...
#> Using `name = 'mtcars'`
#> Guessing `type = 'parquet'`
#> Replacing version '20260923T003900Z-c0340' with
#> '20260923T003901Z-c0340'
#> Writing to pin 'mtcars'
board |> pin_meta("mtcars")
#> List of 13
#>  $ file       : chr "mtcars.parquet"
...
#>  $ tags       : NULL
#>  $ urls       : NULL
#>  $ created    : POSIXct[1:1], format: "2026-09-23 00:39:01"
#>  $ api_version: int 1
#>  $ user       :List of 1
#>   ..$ source: chr "Henderson and Velleman (1981), Building multiple regression models interactively. Biometrics, 37, 391–411."
#>  $ name       : chr "mtcars"
#>  $ local      :List of 3
#>   ..$ dir    : 'fs_path' chr "/tmp/Rtmp2efWaP/pins-21b742929cd6/mtcars/20260923T003901Z-c0340"
#>   ..$ url    : NULL
#>   ..$ version: chr "20260923T003901Z-c0340"
```
...
#> Creating new version '20260923T003901Z-1d21e'
#> Writing to pin 'x'
board2 |> pin_write(2:6, name = "x", type = "rds")
#> Creating new version '20260923T003901Z-76e90'
#> Writing to pin 'x'
board2 |> pin_write(3:7, name = "x", type = "rds")
#> Creating new version '20260923T003902Z-9fb95'
#> Writing to pin 'x'
```
...
#>   <chr>                  <dttm>              <chr>
#> 1 20260923T003901Z-1d21e 2026-09-23 00:39:01 1d21e
#> 2 20260923T003901Z-76e90 2026-09-23 00:39:01 76e90
#> 3 20260923T003902Z-9fb95 2026-09-23 00:39:02 9fb95
```
...
#> Creating new version '20260923T003902Z-28b87'
```
...
#> [1] "/tmp/Rtmp2efWaP/pins-21b742929cd6/example/20260923T003902Z-28b87/mtcars.csv"  
#> [2] "/tmp/Rtmp2efWaP/pins-21b742929cd6/example/20260923T003902Z-28b87/alphabet.txt"
```
...
#> [1] "/tmp/Rtmp2efWaP/pins-21b742929cd6/mtcars/20260923T003901Z-c0340/mtcars.parquet"
```
