...
#> Using `name = 'mtcars'`
#> Creating new version '20260923T003908Z-c2702'
...
#> Creating new version '20260923T003911Z-8416c'
#> Writing to pin 'mtcars'
```
...
#>   <chr>                  <dttm>              <chr>
#> 1 20260923T003908Z-c2702 2026-09-23 00:39:08 c2702
#> 2 20260923T003911Z-8416c 2026-09-23 00:39:11 8416c
```
...
``` yaml
mtcars:
- mtcars/20260923T003908Z-c2702/
- mtcars/20260923T003911Z-8416c/
```
