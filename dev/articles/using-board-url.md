...
#> Using `name = 'mtcars'`
#> Creating new version '20260313T165908Z-c2702'
...
#> Creating new version '20260313T165910Z-8416c'
#> Writing to pin 'mtcars'
```
...
#>   <chr>                  <dttm>              <chr>
#> 1 20260313T165908Z-c2702 2026-03-13 16:59:08 c2702
#> 2 20260313T165910Z-8416c 2026-03-13 16:59:10 8416c
```
...
``` yaml
mtcars:
- mtcars/20260313T165908Z-c2702/
- mtcars/20260313T165910Z-8416c/
```
