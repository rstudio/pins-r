...
[`vignette("customize-pins-metadata")`](https://pins.rstudio.com/dev/articles/customize-pins-metadata.md).
...
#> Creating new version '20260313T210914Z-c2705'
```
...
#> Creating new version '20260313T210915Z-c2705'
```
