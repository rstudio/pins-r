...
#> Creating new version '20251110T190130Z-48c73'
#> Writing to pin 'mtcars-csv'
pin_write(board, mtcars, "mtcars-json", type = "json")
#> Creating new version '20251110T190131Z-c2702'
...
#> mtcars-csv:
#> - mtcars-csv/20251110T190130Z-48c73/
#> mtcars-json:
#> - mtcars-json/20251110T190131Z-c2702/

# if you write another pin, the manifest file is out of date:
pin_write(board, 1:10, "nice-numbers", type = "json")
#> Creating new version '20251110T190131Z-c3943'
