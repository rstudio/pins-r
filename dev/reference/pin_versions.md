...
#> Creating new version '20260923T005615Z-b3722'
#> Writing to pin 'df'
board |> pin_write(data.frame(x = 2:6), name = "df")
#> Guessing `type = 'parquet'`
#> Creating new version '20260923T005615Z-7e49b'
#> Writing to pin 'df'
board |> pin_write(data.frame(x = 3:7), name = "df")
#> Guessing `type = 'parquet'`
#> Creating new version '20260923T005615Z-3bf53'
#> Writing to pin 'df'
...
#>   <chr>                  <dttm>              <chr>
#> 1 20260923T005615Z-3bf53 2026-09-23 00:56:15 3bf53
#> 2 20260923T005615Z-7e49b 2026-09-23 00:56:15 7e49b
#> 3 20260923T005615Z-b3722 2026-09-23 00:56:15 b3722
