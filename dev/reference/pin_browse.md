...
#> Guessing `type = 'rds'`
#> Creating new version '20260923T005610Z-e57c7'
#> Writing to pin 'x'
board |> pin_write(1:11, "x")
#> Guessing `type = 'rds'`
#> Creating new version '20260923T005610Z-794be'
#> Writing to pin 'x'
board |> pin_write(1:12, "x")
#> Guessing `type = 'rds'`
#> Creating new version '20260923T005610Z-28412'
#> Writing to pin 'x'

board |> pin_browse("x", local = TRUE)
#> ℹ Pin at </tmp/RtmpGC6St1/pins-19ad45a39fd/x/20260923T005610Z-e57c7>
```
