---
title: "Reusing Tidy Datasets"
output:
  html_document:
    df_print: paged
---

This dataset makes use of the "A Million News Headlines" dataset available at [kaggle.com/therohk/million-headlines](https://www.kaggle.com/therohk/million-headlines).
...
![](images/reusing-analysis-rsconnect.png)
